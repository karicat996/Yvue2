...
import UserInfo from "../profile1/homeprofile/UserInfo.vue";
import detailInfo from "../profile1/homeprofile/detailInfo.vue";
import ListView from "../profile1/homeprofile/ListView.vue";
export default {
  name: "Profile",
  components: {
    NavBar,
